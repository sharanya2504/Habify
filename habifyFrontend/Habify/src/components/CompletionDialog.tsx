  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      ...
      >
        ...
        {/* ✅ Add DialogDescription for accessibility - hidden visually */}
        <DialogDescription className="sr-only">
          You have completed your habit and earned {xpGained} experience points. Celebration message with confetti animation.
        </DialogDescription>
